...
def run():
    ...
    Scikit_Simple_Logistic_Regression(X,Y)
    ...
    #AnalyzeDifferentParameters(X,Y)
    plt.show()

def AnalyzeDifferentParameters(X,Y):
    plt.figure(figsize=(16, 32))
    hidden_layer_sizes = [1, 2, 3, 4, 5, 20] #, 50,75,100]
...
def Scikit_Simple_Logistic_Regression(X,Y):
